...
@Component({
    moduleId: module.id,
    selector: 'app_calisan_maas_prim_ekle_form_component',
    template: `
    ...
    <div class="panel panel-light">
        ...
        <div class="panel-body">
          ...
          <!-- Ödeme Durumu -->
           ...
           <!-- Ödeme Tarihi -->
          <div class="form-group">
            <label for="FaturaOdemeTarihi" class="control-label form-style-ozel-label">{{ odeme_durumu == 'Odendi' ? 'Ödeme Tarihi' : 'Ödeneceği Tarih' }}</label>
...
export class CalisanMaasPrimEkleFormComponent implements OnInit {
